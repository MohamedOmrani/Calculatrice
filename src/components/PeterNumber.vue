<template>
  <el-row>
      <el-col :span="8" :offset="8">
         <el-form ref="number" name="number" :model="number" :rules="rulesNumber" >
            <el-form-item label="Number" prop="peterNumber">
                <el-input name="peterNumber" placeholder="Number"  style="width: 100%;height:45%" v-model="number.peterNumber"></el-input>
            </el-form-item>
             <el-form-item label="Result">
                <el-input placeholder="Result" style="width: 100%;height:45%"  v-model="number.highestNb"></el-input>
            </el-form-item>
            <el-button type="primary" style="width: 45%;height:45%"  @click="find">Find</el-button>
            <el-button type="danger" style="width: 45%;height:45%"   @click="clear">Clean</el-button>
        </el-form>
  </el-col>
  </el-row>
</template>
